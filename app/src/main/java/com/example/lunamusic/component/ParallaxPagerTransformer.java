package com.example.lunamusic.component;
...
public class ParallaxPagerTransformer implements ViewPager.PageTransformer {
    ...
    public ParallaxPagerTransformer(@NonNull List<ParallaxTransformInformation> viewsToParallax) {
        mViewsToParallax = viewsToParallax;
    }

    public ParallaxPagerTransformer addViewToParallax(@NonNull ParallaxTransformInformation viewInfo) {
