...
package com.example.androidisshit.utils.ColorUtils;
...
public class MediaNotificationProcessor {
    ...
    private static final int RESIZE_BITMAP_AREA = 50 * 50;
    ...
    public MediaNotificationProcessor(Drawable drawable) {
        this.drawable = drawable;
        getMediaPalette();
    }

    public MediaNotificationProcessor() {}

    public void getPaletteAsync(Drawable drawable, final OnPaletteLoadedListener onPaletteLoadedListener) {
        this.drawable = drawable;
    ...
    private void ensureColors(int backgroundColor, int mForegroundColor) {
        {
            ...
            if (contrast < 4.5f) {
                if (backgroundLight) {
                    secondaryTextColor = ContrastColorUtil.findContrastColor(
                            mForegroundColor,
                            backgroundColor,
                            true /* findFG */,
                            4.5f);
                    primaryTextColor = ContrastColorUtil.changeColorLightness(
                ...
                secondaryTextColor = ContrastColorUtil.changeColorLightness(
                        primaryTextColor, backgroundLight ? LIGHTNESS_TEXT_DIFFERENCE_LIGHT
                                : LIGHTNESS_TEXT_DIFFERENCE_DARK);
                if (ContrastColorUtil.calculateContrast(secondaryTextColor,
