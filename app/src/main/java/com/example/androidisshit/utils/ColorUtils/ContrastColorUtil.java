...
/*
 *This file is extract from android system, used for learning
 */
...
//        }
        if (sInstance == null) {
            sInstance = new ContrastColorUtil();
        }
        return sInstance;
    }
...
//        mGrayscaleIconMaxSize = context.getResources().getDimensionPixelSize(64);
//    }
//
//    /**
